    ...
    <div class="p-6">
      <nav class="space-y-4">
        ...
        >
          ...
          <div class="text-left">
            <h3 class="font-semibold text-gray-900">Página Inicial</h3>
            <p class="text-sm text-gray-500">Voltar para a página principal</p>
          </div>
        </button>
        <button
            v-else
        ...
        >
          ...
          <div class="text-left">
            <h3 class="font-semibold text-gray-900">Hospitais</h3>
        ...
        >
          ...
          >
            ...
            >
              <path
                  d="M4.22 11.29l6.59-6.59C11.42 4.08 12.2 3.75 13 3.75s1.58.33 2.19.95L20.78 10.29c1.28 1.28 1.28 3.36 0 4.64L14.19 21.52c-.61.61-1.39.95-2.19.95s-1.58-.33-2.19-.95L3.22 15.93c-1.28-1.28-1.28-3.36 0-4.64z"
              />
            </svg>
          </div>
          <div class="text-left">
