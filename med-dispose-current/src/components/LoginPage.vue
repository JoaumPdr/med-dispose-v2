        ...
        <div>
          ...
          <div class="relative">
            <input
              ...
              placeholder="••••••••"
            />
            <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 flex items-center pr-3 text-xs text-blue-600">
...
const handleLogin = async () => {
  ...
  try {
    ...
    try {
      ...
      router.push('/main-page'); // Redireciona para a MainPage após o login
      return;
    } catch (hospitalError) {
